...
public class multiplelogin {
  ...
  public void f(String userName, String passWord, String msg)throws InterruptedException {
...
//1. Create a dataProvider method. In dataProvider method the return time of the method is array and values are returned in form of array.
 public Object[][] dp() {
   ...
   return new Object[][] {
   	new Object[] { "vasundara", "admin123" ,"Test failed-Wrong Credentials"}, 
       new Object[] { "vasubala", "admin566","Test failed-Wrong Credentials" },
